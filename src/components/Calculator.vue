<template>
  <div class="calculator">
    <input v-model.number="operand1" name="operand1" class="operand1" />
    <input v-model.number="operand2" name="operand2" class="operand2" />
    = {{ result }}
    <div>
      <button
    ...
    <label
      ><input type="checkbox" v-model="showvk" class="showvk" />Отобразить
    ...
    <div v-if="showvk">
      ...
      <button @click="eraseOne" class="erase">E</button>
      <br /><br />
